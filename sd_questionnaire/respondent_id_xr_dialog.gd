...
func _ensure_nodes() -> void:
	...
	_viewport.name = "RespondentIdViewport"
	...
	if prefer_openxr_composition_layer and ClassDB.class_exists("OpenXRCompositionLayerQuad"):
		...
		if is_instance_valid(_composition_layer):
			_composition_layer.name = "RespondentIdOpenXRCompositionLayerQuad"
...
func _create_fallback_quad() -> void:
	...
	_fallback_quad.name = "RespondentIdFallbackQuad"
...
func push_input_event(event: InputEvent) -> void:
	_ensure_nodes()
